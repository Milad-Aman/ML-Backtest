...
- `ewma_vol`: rolling EWMA volatility (daily scale).
...
def ewma_vol(returns: pd.Series, span: int = 30) -> pd.Series:
    """EWMA standard deviation of returns with span `span` (daily units)."""
